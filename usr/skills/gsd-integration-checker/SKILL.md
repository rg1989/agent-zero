...
description: Validates integration correctness between components — checks that APIs, types, and data flows connect properly. Spawned as a subagent during verification workflows.
allowed-tools:
  - code_execution_tool
---
