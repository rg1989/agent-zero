...
- [ ] **TERM-01**: Agent Zero can send text + Enter to a named tmux pane in the shared terminal
- [ ] **TERM-02**: Agent Zero can send text without Enter to a named tmux pane (partial input for inline prompts like `y/N`)
- [ ] **TERM-03**: Agent Zero can send special keys to a named tmux pane (Ctrl+C, Ctrl+D, Tab, Escape, arrow keys)
- [ ] **TERM-04**: Agent Zero can capture and read current terminal screen content from a tmux pane
