...
- [x] **SKILL-05**: Agent auto-selects the best template based on the user's request, tells the user which one was chosen, and allows override if asked

### Template Library

- [x] **TMPL-01**: Real-time dashboard template exists with periodic data refresh and Chart.js or Plotly charts in a responsive grid layout
