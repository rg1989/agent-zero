...
- [x] **CLAUDE-05**: A dedicated `claude-cli` skill (`usr/skills/claude-cli/SKILL.md`) documents the validated invocation patterns: single-turn (`--print`), multi-turn (`--resume UUID`), env fix, ANSI stripping, and completion detection
